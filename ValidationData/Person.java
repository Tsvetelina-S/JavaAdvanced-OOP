...
public class Person {
    ...
    public void setFirstName(String firstName) {
        if(firstName.length() < 3){
            throw new IllegalArgumentException("First name cannot be less than less than 3 symbols");
        }
        this.firstName = firstName;
    }
    ...
    public void setLastName(String lastName) {
        if(lastName.length() < 3){
            throw new IllegalArgumentException("Last name cannot be less than less than 3 symbols");
        }
        this.lastName = lastName;
    }
